    ...
    return (
        ...
        <div className="border-top" style={{ backgroundColor: "rgb(250,250,250)" }} >
            ...
            <div className="row  ">
                ...
                <div className="col ">
                    <img  className=" mb-3"   src="media/images/logo.svg" alt="" style={{ width: "50%" }} />
                    <p  style={{fontSize: "14px", color:"grey" }}> &copy; 2010-2025, Zerodha Broking Ltd.
                ...
                <div className="col ">
                    ...
                    <a     href="">  Open demat accoun</a><br />
                    <a   href=""> Minor demat accoun</a><br />
