    ...
    return (
        ...
        <div className="container">
            ...
            <div className="row  mt-5  mb-5  p-5 ">
                <h1 className=" fs-4  text-center " style={{ lineHeight: "1.6", fontWeight:"500", color: "rgb(60,60,60" }}>We pioneered the discount broking model in India. <br />
                    Now, we are breaking ground with our technology.</h1>
            </div> 

            <div className="row   border-top mt-5  mx-5 p-5    " style={{lineHeight:"1.8",fontSize:"1.1em" }}>
